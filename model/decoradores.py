...
class LocacaoDecorator(ABC):
    ...
    # Garante o Duck Typing repassando atributos não encontrados (como data_inicio) para o alvo envelopado
    def __getattr__(self, attr):
        return getattr(self.locacao_alvo, attr)
...
class SeguroTerceirosDecorator(LocacaoDecorator):
    ...
    def calcular_valor_locacao(self) -> float:
        # Pega os dias por inferência, valendo-se da flexibilidade do Duck Typing do Python
